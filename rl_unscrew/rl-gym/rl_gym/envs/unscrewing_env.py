...
class UnscrewingEnv(gym.Env):
    ...
    def __init__(self):
        ...
        #Setup subscriber to subscribe current pose
        #rospy.Subscriber("/curr_pose", String, callback)
    ...
    def step(self, action):
        ...
        while current_pose == None:
            try:
                current_pose = rospy.wait_for_message('/curr_pose', geometry_msgs.msg.PoseStamped, 10)
            except:
                rospy.sleep(10)
    ...
    def reset(self):
        ...
        while reset_succes == None:
            try:
                ...
                reset_succes = self.reset_robot.call(trigger)
